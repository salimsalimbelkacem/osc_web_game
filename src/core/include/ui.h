...
typedef enum {
  UI_CONTENT_ALIGN_LEFT,
  UI_CONTENT_ALIGN_CENTER,
  UI_CONTENT_ALIGN_RIGHT
} UI_Content_HAlign_Type;

typedef enum {
  UI_CONTENT_ALIGN_TOP,
  UI_CONTENT_ALIGN_MIDDLE,
  UI_CONTENT_ALIGN_BOTTOM
} UI_Content_VAlign_Type;
